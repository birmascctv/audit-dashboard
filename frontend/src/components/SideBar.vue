<template>
  <aside class="sidebar-container bg-slate-900 border-r border-slate-800 text-slate-200 flex flex-col fixed top-0 left-0 bottom-0 z-40 w-64">
    <!-- Brand Header -->
    <div class="brand-header p-5 border-b border-slate-800 flex items-center gap-3">
